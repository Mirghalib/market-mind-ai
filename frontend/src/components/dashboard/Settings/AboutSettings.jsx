  ...
  return (
    ...
    >
      <div className="flex items-center gap-3">
        ...
        <div>
          <h2 className="text-base font-semibold text-foreground dark:text-white">About</h2>
      ...
      <div className="mt-6 flex items-center gap-4">
        ...
        <div>
          <p className="text-base font-semibold text-foreground dark:text-white">{APP_NAME}</p>
          <p className="text-sm text-muted-foreground dark:text-zinc-400">
      ...
      <dl className="mt-6 grid gap-4 sm:grid-cols-2">
        <div className="rounded-xl border border-border bg-muted p-4 dark:border-white/5 dark:bg-white/[0.02]">
          <dt className="text-xs font-medium tracking-wide text-muted-foreground uppercase dark:text-zinc-400">
            Version
          </dt>
          <dd className="mt-1 text-sm font-semibold text-foreground dark:text-white">0.1.0</dd>
        </div>
        <div className="rounded-xl border border-border bg-muted p-4 dark:border-white/5 dark:bg-white/[0.02]">
          <dt className="text-xs font-medium tracking-wide text-muted-foreground uppercase dark:text-zinc-400">
            Status
